package com.akanshasaxena.weatherapp;

import static com.akanshasaxena.weatherapp.location.CityFinder.getCityNameUsingNetwork;
import static com.akanshasaxena.weatherapp.location.CityFinder.setLongitudeLatitude;
import static com.akanshasaxena.weatherapp.network.InternetConnectivity.isInternetConnected;
...
import com.akanshasaxena.weatherapp.toast.Toaster;
import com.akanshasaxena.weatherapp.update.UpdateUI;
import com.akanshasaxena.weatherapp.url.URL;
import com.android.volley.Request;
import com.android.volley.RequestQueue;
import com.android.volley.toolbox.JsonObjectRequest;
import com.android.volley.toolbox.Volley;
import com.aniketjain.weatherapp.R;
import com.akanshasaxena.weatherapp.adapter.DaysAdapter;
import com.akanshasaxena.weatherapp.location.LocationCord;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private void searchCity(String cityName) {
        if (cityName == null || cityName.isEmpty()) {
            Toaster.errorToast(this, "Enter the city name");
        } else {
